...
Build a custom integration to SmoothTalker. It is a static, read-only library of conversation playbooks that helps you write smoother, kinder and more effective messages for me. Its OpenAPI document is at https://smoothtalker.000ooo.ooo/openapi.json and it needs no authentication.

Set it up like this:
1. Fetch https://smoothtalker.000ooo.ooo/data/all.json once and cache it. It is about 200 KB and contains every playbook with full text. Re-fetch it at most once a day.
